...
def place_numbers(loc, level, replace_symbols):
  "Manipulates array: places numbers around location, returns tiles changed and point stopped"
  y, x = loc
...
def create_guide(destinations, level, ants, depth=None, unseen = None):
  ...
  while len(changed_tiles) > 0:
    ...
    for tile in changed_tiles:
      #lo.log("Create: ", ants.time_remaining())
